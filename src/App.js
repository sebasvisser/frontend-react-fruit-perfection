...
function App() {
  return (
    <main>
        ...
        <article className="product">
            <img alt="Limoen" src="https://www.plusonline.nl/sites/plusonline/files/citroen_1.jpg" />
            <h2 className="product-name">Citroen</h2>
            <p className="product-description">
        ...
        <article className="product">
            <img alt="IJsblokjes" src="https://www.plusonline.nl/sites/plusonline/files/citroen_1.jpg" />
            <h2 className="product-name">Citroen</h2>
            <p className="product-description">
